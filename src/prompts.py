...
class AnswerWithRAGContextStringPrompt:
    ...
    class AnswerSchema(BaseModel):
        step_by_step_analysis: str = Field(description="详细分步推理过程，至少5步，150字以上。特别注意问题措辞，避免被迷惑。")
        reasoning_summary: str = Field(description="简要总结分步推理过程，约50字。")
        relevant_pages: List[int] = Field(description="""
...
列表中至少应有一个页面。
""")
        final_answer: str = Field(description="基于上下文生成的完整文本答案，应全面、准确、简洁地回答问题。")
...
```
{
  "step_by_step_analysis": "1. 问题要求总结中芯国际2024年主营业务的主要内容。\n2. 年报第1页明确指出：中芯国际是世界领先的集成电路晶圆代工企业之一，也是中国大陆集成电路制造业领导者，拥有领先的工艺制造能力、产能优势、服务配套，向全球客户提供8英寸和12英寸晶圆代工与技术服务。\n3. 同时，年报第6页提到：除晶圆代工业务外，公司致力于打造平台式生态服务模式，提供设计服务与IP支持、光掩模制造等一站式配套服务，并促进产业链上下游协同。\n4. 结合上下文，归纳出核心业务为晶圆代工及配套服务。\n5. 形成简明扼要的总结。",
  "reasoning_summary": "年报第1页和第6页直接说明了中芯国际的核心业务，答案基于原文归纳。",
  "relevant_pages": [1, 6],
  "final_answer": "中芯国际2024年主营业务包括集成电路晶圆代工（覆盖8英寸和12英寸技术平台）以及设计服务与IP支持、光掩模制造等一站式配套服务，致力于为客户提供全方位的集成电路解决方案。"
}
```
"""
